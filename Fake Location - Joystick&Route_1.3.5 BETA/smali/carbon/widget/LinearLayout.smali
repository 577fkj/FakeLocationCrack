...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcarbon/widget/LinearLayout;->ԩ:Lࡪ/ޅ;
    ...
    iput-object p1, p0, Lcarbon/widget/LinearLayout;->Ԭ:Landroid/graphics/Paint;

    new-instance p1, Lࡨ/ֈ;

    invoke-direct {p1}, Lࡨ/ֈ;-><init>()V

    iput-object p1, p0, Lcarbon/widget/LinearLayout;->ԯ:Lࡨ/ֈ;

    const/4 p1, 0x0

    iput p1, p0, Lcarbon/widget/LinearLayout;->ՠ:F

    iput p1, p0, Lcarbon/widget/LinearLayout;->ֈ:F

    new-instance p1, Lࡧ/ރ;

    invoke-direct {p1, p0}, Lࡧ/ރ;-><init>(Lࡧ/ނ;)V

    iput-object p1, p0, Lcarbon/widget/LinearLayout;->ؠ:Lࡧ/ރ;

    sget-object p1, Lࡧ/Ԩ$ׯ;->ԩ:Lࡧ/Ԩ$ׯ;

    iput-object p1, p0, Lcarbon/widget/LinearLayout;->ހ:Lࡧ/Ԩ$ׯ;

    iput-object p1, p0, Lcarbon/widget/LinearLayout;->ށ:Lࡧ/Ԩ$ׯ;

    const/4 p1, -0x1

    iput p1, p0, Lcarbon/widget/LinearLayout;->ރ:I

    iput p1, p0, Lcarbon/widget/LinearLayout;->ބ:I

    iput p1, p0, Lcarbon/widget/LinearLayout;->ޅ:I

    iput p1, p0, Lcarbon/widget/LinearLayout;->ކ:I

    const p1, 0x7fffffff

    iput p1, p0, Lcarbon/widget/LinearLayout;->ވ:I

    iput p1, p0, Lcarbon/widget/LinearLayout;->މ:I

    invoke-virtual {p0, v0}, Lcarbon/widget/LinearLayout;->Ԫ(Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, p2}, Lcarbon/widget/LinearLayout;->Ԫ(Landroid/util/AttributeSet;)V

    return-void
.end method

.method public static synthetic ԩ(Lcarbon/widget/LinearLayout;I)V
    .locals 0
...
.method public final dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iput-object v0, p0, Lcarbon/widget/LinearLayout;->ԫ:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcarbon/widget/LinearLayout;->ԫ:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ԫ:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->Ԯ:Lࡩ/֏;
    ...
    :cond_1
    iget v0, p0, Lcarbon/widget/LinearLayout;->އ:I

    if-eqz v0, :cond_5

    iget-object v7, p0, Lcarbon/widget/LinearLayout;->Ԭ:Landroid/graphics/Paint;
    ...
    iget v0, p0, Lcarbon/widget/LinearLayout;->ރ:I
    ...
    :cond_2
    iget v0, p0, Lcarbon/widget/LinearLayout;->ބ:I
    ...
    :cond_3
    iget v0, p0, Lcarbon/widget/LinearLayout;->ޅ:I
    ...
    iget v1, p0, Lcarbon/widget/LinearLayout;->ޅ:I
    ...
    :cond_4
    iget v0, p0, Lcarbon/widget/LinearLayout;->ކ:I
    ...
    iget v1, p0, Lcarbon/widget/LinearLayout;->ކ:I
...
.method public final dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->Ԫ:Landroid/view/View$OnTouchListener;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lcarbon/widget/LinearLayout;->ԭ:I
...
.method public final drawableStateChanged()V
    ...
    :cond_0
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ؠ:Lࡧ/ރ;
...
.method public final fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    iput v0, p0, Lcarbon/widget/LinearLayout;->ރ:I
    ...
    iput v0, p0, Lcarbon/widget/LinearLayout;->ބ:I
    ...
    iput v0, p0, Lcarbon/widget/LinearLayout;->ޅ:I
    ...
    iput v0, p0, Lcarbon/widget/LinearLayout;->ކ:I

    :cond_3
    iget v0, p0, Lcarbon/widget/LinearLayout;->ރ:I

    iget v1, p0, Lcarbon/widget/LinearLayout;->ބ:I

    iget v2, p0, Lcarbon/widget/LinearLayout;->ޅ:I

    iget v3, p0, Lcarbon/widget/LinearLayout;->ކ:I
...
.method public final generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    new-instance v0, Lcarbon/widget/LinearLayout$Ԫ;

    invoke-super {p0}, Landroid/widget/LinearLayout;->generateDefaultLayoutParams()Landroid/widget/LinearLayout$LayoutParams;

    move-result-object v1

    invoke-direct {v0, v1}, Lcarbon/widget/LinearLayout$Ԫ;-><init>(Landroid/widget/LinearLayout$LayoutParams;)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lcarbon/widget/LinearLayout$Ԫ;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lcarbon/widget/LinearLayout$Ԫ;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public getAnimator()Lʾ/Ϳ;
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ނ:Lʾ/Ϳ;
...
.method public final getChildDrawingOrder(II)I
    ...
    iget-object p1, p0, Lcarbon/widget/LinearLayout;->ԫ:Ljava/util/ArrayList;
...
.method public getElevation()F
    ...
    iget v0, p0, Lcarbon/widget/LinearLayout;->ՠ:F
...
.method public final getHitRect(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ׯ:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lcarbon/widget/LinearLayout;->ׯ:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lcarbon/widget/LinearLayout;->ׯ:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Lcarbon/widget/LinearLayout;->ׯ:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Lcarbon/widget/LinearLayout;->ׯ:Landroid/graphics/Rect;
...
.method public getInAnimation()Lࡧ/Ԩ$ׯ;
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ހ:Lࡧ/Ԩ$ׯ;
...
.method public getMaximumHeight()I
    ...
    iget v0, p0, Lcarbon/widget/LinearLayout;->މ:I
...
.method public getMaximumWidth()I
    ...
    iget v0, p0, Lcarbon/widget/LinearLayout;->ވ:I
...
.method public getOutAnimation()Lࡧ/Ԩ$ׯ;
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ށ:Lࡧ/Ԩ$ׯ;
...
.method public getPivotX()F
    ...
    .line 12
    :cond_0
    invoke-super {p0}, Landroid/widget/LinearLayout;->getPivotX()F
...
.method public getPivotY()F
    ...
    .line 12
    :cond_0
    invoke-super {p0}, Landroid/widget/LinearLayout;->getPivotY()F
...
.method public getRotationX()F
    ...
    .line 12
    :cond_0
    invoke-super {p0}, Landroid/widget/LinearLayout;->getRotationX()F
...
.method public getRotationY()F
    ...
    .line 12
    :cond_0
    invoke-super {p0}, Landroid/widget/LinearLayout;->getRotationY()F
...
.method public getScaleX()F
    ...
    .line 12
    :cond_0
    invoke-super {p0}, Landroid/widget/LinearLayout;->getScaleX()F
...
.method public getScaleY()F
    ...
    .line 12
    :cond_0
    invoke-super {p0}, Landroid/widget/LinearLayout;->getScaleY()F
...
.method public getShadow()Lࡰ/Ԩ;
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->֏:Lࡰ/Ϳ;
    ...
    iput-object v0, p0, Lcarbon/widget/LinearLayout;->֏:Lࡰ/Ϳ;
...
.method public getTranslationY()F
    ...
    .line 12
    :cond_0
    invoke-super {p0}, Landroid/widget/LinearLayout;->getTranslationY()F
...
.method public getTranslationZ()F
    ...
    iget v0, p0, Lcarbon/widget/LinearLayout;->ֈ:F
...
.method public final invalidate()V
    ...
    invoke-virtual {p0}, Lcarbon/widget/LinearLayout;->getCornerRadius()I
...
.method public final invalidateDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iget-object p1, p0, Lcarbon/widget/LinearLayout;->Ԯ:Lࡩ/֏;
...
.method public final onLayout(ZIIII)V
    ...
    .line 28
    check-cast p5, Lcarbon/widget/LinearLayout$Ԫ;

    .line 29
    .line 30
    iget v0, p5, Lcarbon/widget/LinearLayout$Ԫ;->Ԫ:I
    ...
    .line 58
    iget v5, p5, Lcarbon/widget/LinearLayout$Ԫ;->ԫ:I
    ...
    .line 70
    iget v4, p5, Landroid/widget/LinearLayout$LayoutParams;->height:I
    ...
    .line 110
    iget v2, p5, Landroid/widget/LinearLayout$LayoutParams;->width:I
    ...
    .line 132
    iget p5, p5, Landroid/widget/LinearLayout$LayoutParams;->width:I
    ...
    .line 151
    iput-object p1, p0, Lcarbon/widget/LinearLayout;->֏:Lࡰ/Ϳ;
    ...
    .line 189
    :cond_8
    iget p1, p0, Lcarbon/widget/LinearLayout;->ԭ:I
    ...
    .line 220
    :cond_a
    iget-object p1, p0, Lcarbon/widget/LinearLayout;->ԩ:Lࡪ/ޅ;
...
.method public final onMeasure(II)V
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ԩ:Lࡪ/ޅ;
    ...
    iget v1, p0, Lcarbon/widget/LinearLayout;->ވ:I
    ...
    iget v1, p0, Lcarbon/widget/LinearLayout;->މ:I
...
.method public final postInvalidate(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroid/widget/LinearLayout;->postInvalidate(IIII)V
...
.method public setAlpha(F)V
    ...
    :goto_0
    iget p1, p0, Lcarbon/widget/LinearLayout;->ՠ:F
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Lcarbon/widget/LinearLayout;->setRippleDrawable(Lࡩ/֏;)V
    ...
    iput-object v1, p0, Lcarbon/widget/LinearLayout;->Ԯ:Lࡩ/֏;

    :cond_1
    if-nez p1, :cond_2

    iget-object p1, p0, Lcarbon/widget/LinearLayout;->ԯ:Lࡨ/ֈ;
...
.method public setCornerRadius(I)V
    ...
    .line 1
    iput p1, p0, Lcarbon/widget/LinearLayout;->ԭ:I
...
.method public setInsetColor(I)V
    ...
    iput p1, p0, Lcarbon/widget/LinearLayout;->އ:I
...
.method public setOnDispatchTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    iput-object p1, p0, Lcarbon/widget/LinearLayout;->Ԫ:Landroid/view/View$OnTouchListener;
...
.method public setRippleDrawable(Lࡩ/֏;)V
    ...
    iget-object v0, p0, Lcarbon/widget/LinearLayout;->ԯ:Lࡨ/ֈ;
    ...
    :cond_2
    iput-object p1, p0, Lcarbon/widget/LinearLayout;->Ԯ:Lࡩ/֏;
...
.method public setVisibility(I)V
    ...
    iget-object v1, p0, Lcarbon/widget/LinearLayout;->ނ:Lʾ/Ϳ;
    ...
    :cond_1
    iget-object v1, p0, Lcarbon/widget/LinearLayout;->ހ:Lࡧ/Ԩ$ׯ;

    if-eq v1, v0, :cond_2

    new-instance v0, Lcarbon/widget/LinearLayout$Ϳ;

    invoke-direct {v0, p0}, Lcarbon/widget/LinearLayout$Ϳ;-><init>(Lcarbon/widget/LinearLayout;)V

    invoke-static {p0, v1, v0}, Lࡧ/Ԩ;->Ϳ(Landroid/view/View;Lࡧ/Ԩ$ׯ;Lʾ/Ԩ;)Lʾ/ށ;

    move-result-object v0

    iput-object v0, p0, Lcarbon/widget/LinearLayout;->ނ:Lʾ/Ϳ;
    ...
    :cond_5
    iget-object v1, p0, Lcarbon/widget/LinearLayout;->ށ:Lࡧ/Ԩ$ׯ;
    ...
    :cond_6
    new-instance v0, Lcarbon/widget/LinearLayout$Ԩ;

    invoke-direct {v0, p0, p1}, Lcarbon/widget/LinearLayout$Ԩ;-><init>(Lcarbon/widget/LinearLayout;I)V

    invoke-static {p0, v1, v0}, Lࡧ/Ԩ;->Ԩ(Landroid/view/View;Lࡧ/Ԩ$ׯ;Lʾ/Ԩ;)Lʾ/ށ;

    move-result-object p1

    iput-object p1, p0, Lcarbon/widget/LinearLayout;->ނ:Lʾ/Ϳ;
...
.method public final Ϳ(IIII)V
    ...
    iput p2, p0, Lcarbon/widget/LinearLayout;->ބ:I

    iput p3, p0, Lcarbon/widget/LinearLayout;->ޅ:I

    iput p4, p0, Lcarbon/widget/LinearLayout;->ކ:I
...
.method public final Ԩ(IIII)V
    ...
    iput-object v0, p0, Lcarbon/widget/LinearLayout;->ׯ:Landroid/graphics/Rect;

    return-void
.end method

.method public final Ԫ(Landroid/util/AttributeSet;)V
    .locals 4
    ...
    sget-object v2, Landroidx/lifecycle/ދ;->ࡠ:[I
    ...
    invoke-static {p0, p1, v3}, Lࡦ/Ϳ;->ԭ(Lࡩ/ނ;Landroid/util/AttributeSet;I)V

    invoke-static {p0, p1, v3}, Lࡦ/Ϳ;->Ԫ(Lࡰ/Ԯ;Landroid/util/AttributeSet;I)V

    invoke-static {p0, p1, v3}, Lࡦ/Ϳ;->ԩ(Lࡧ/ނ;Landroid/util/AttributeSet;I)V

    invoke-static {p0, p1, v3}, Lࡦ/Ϳ;->ԯ(Lࡱ/ޅ;Landroid/util/AttributeSet;I)V

    invoke-static {p0, p1, v3}, Lࡦ/Ϳ;->ԫ(Lࡱ/֏;Landroid/util/AttributeSet;I)V

    invoke-static {p0, p1, v3}, Lࡦ/Ϳ;->Ԭ(Lࡱ/ׯ;Landroid/util/AttributeSet;I)V

    const/4 p1, 0x0

    invoke-virtual {v1, v0, p1}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result p1

    float-to-int p1, p1

    invoke-virtual {p0, p1}, Lcarbon/widget/LinearLayout;->setCornerRadius(I)V
