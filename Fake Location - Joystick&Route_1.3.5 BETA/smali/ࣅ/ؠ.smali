...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lࣅ/ؠ;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lࣅ/ؠ;->ԫ:Landroid/graphics/Rect;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lࣅ/ؠ;->Ԭ:Z

    iput-boolean v0, p0, Lࣅ/ؠ;->ԭ:Z

    sget-object v3, Landroidx/lifecycle/ދ;->ࢎ:[I
    ...
    iput-object p2, p0, Lࣅ/ؠ;->ԩ:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    invoke-virtual {p0, v0}, Landroid/view/View;->setWillNotDraw(Z)V

    new-instance p1, Lࣅ/ؠ$Ϳ;

    invoke-direct {p1, p0}, Lࣅ/ؠ$Ϳ;-><init>(Lࣅ/ؠ;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Lࣅ/ؠ;->Ԫ:Landroid/graphics/Rect;

    if-eqz v2, :cond_2

    iget-object v2, p0, Lࣅ/ؠ;->ԩ:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v3, p0, Lࣅ/ؠ;->Ԭ:Z

    const/4 v4, 0x0

    iget-object v5, p0, Lࣅ/ؠ;->ԫ:Landroid/graphics/Rect;

    if-eqz v3, :cond_0

    iget-object v3, p0, Lࣅ/ؠ;->Ԫ:Landroid/graphics/Rect;

    iget v3, v3, Landroid/graphics/Rect;->top:I

    invoke-virtual {v5, v4, v4, v0, v3}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v3, p0, Lࣅ/ؠ;->ԩ:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lࣅ/ؠ;->ԩ:Landroid/graphics/drawable/Drawable;
...
.method public setScrimInsetForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Lࣅ/ؠ;->ԩ:Landroid/graphics/drawable/Drawable;

    return-void
.end method

.method public Ϳ(Lޚ/ސ;)V
    .locals 0
