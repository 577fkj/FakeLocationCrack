...
.method public a()V
    ...
    const-string v1, "sendJson:"

    const/4 v2, 0x0

    :try_start_0
    const-string v3, "report static alive for start"

    invoke-static {v3}, Lcom/baidu/mshield/b/c/a;->a(Ljava/lang/String;)V

    iget-object v3, p0, Lcom/baidu/mshield/x6/d/c;->b:Lcom/baidu/mshield/x6/d/h;

    invoke-virtual {v3}, Lcom/baidu/mshield/x6/d/h;->a()Lorg/json/JSONObject;
    ...
    iget-object v5, p0, Lcom/baidu/mshield/x6/d/c;->a:Landroid/content/Context;

    sget-object v6, Lcom/baidu/mshield/x6/e/g;->c:Ljava/lang/String;

    :goto_0
    invoke-static {v5, v3, v6, v4}, Lcom/baidu/mshield/x6/e/f;->a(Landroid/content/Context;Lorg/json/JSONObject;Ljava/lang/String;Z)Lorg/json/JSONObject;
    ...
    iget-object v1, p0, Lcom/baidu/mshield/x6/d/c;->a:Landroid/content/Context;

    invoke-static {v1}, Lcom/baidu/mshield/b/a/d;->b(Landroid/content/Context;)Z

    move-result v1

    if-nez v1, :cond_1

    sput-boolean v2, Lcom/baidu/mshield/x6/d/i;->c:Z
    :try_end_0
    ...
    invoke-static {v1, v3}, Lcom/baidu/mshield/x6/e/l;->a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lcom/baidu/mshield/x6/d/c;->c:Lcom/baidu/mshield/x6/a/b;

    invoke-static {}, Lcom/baidu/mshield/x6/e/f;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/baidu/mshield/x6/a/b;->k(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/baidu/mshield/x6/d/c;->c:Lcom/baidu/mshield/x6/a/b;

    invoke-virtual {v0, v4}, Lcom/baidu/mshield/x6/a/b;->g(Z)V

    iget-object v0, p0, Lcom/baidu/mshield/x6/d/c;->c:Lcom/baidu/mshield/x6/a/b;

    invoke-virtual {v0, v2}, Lcom/baidu/mshield/x6/a/b;->a(Z)V
    ...
    invoke-virtual {v3, v0, v1}, Lcom/baidu/mshield/x6/d/f;->a(J)V
    :try_end_1
