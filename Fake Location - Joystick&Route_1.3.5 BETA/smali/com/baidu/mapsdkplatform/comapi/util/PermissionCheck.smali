...
.method public static declared-synchronized permissionCheck()I
    ...
    const-string v0, "permission check result is: "

    const-string v1, "The authManager is: "

    const-class v2, Lcom/baidu/mapsdkplatform/comapi/util/PermissionCheck;
    ...
    sget-object v5, Lcom/baidu/mapsdkplatform/comapi/util/PermissionCheck;->e:Landroid/content/Context;
    ...
    :cond_0
    sget-object v1, Lcom/baidu/mapsdkplatform/comapi/util/PermissionCheck;->f:Ljava/lang/String;

    invoke-virtual {v3, v1}, Lcom/baidu/lbsapi/auth/LBSAuthManager;->setKey(Ljava/lang/String;)V
    ...
    sget-object v6, Lcom/baidu/mapsdkplatform/comapi/util/PermissionCheck;->i:Lcom/baidu/lbsapi/auth/LBSAuthManagerListener;

    invoke-virtual {v1, v4, v3, v5, v6}, Lcom/baidu/lbsapi/auth/LBSAuthManager;->authenticate(ZLjava/lang/String;Ljava/util/Hashtable;Lcom/baidu/lbsapi/auth/LBSAuthManagerListener;)I

    move-result v1

    if-eqz v1, :cond_2

    sget-object v3, Lcom/baidu/mapsdkplatform/comapi/util/PermissionCheck;->d:Ljava/lang/String;
    ...
    const-string v1, "; the authCallback is: "
    ...
    const-string v1, "; the mContext is: "
