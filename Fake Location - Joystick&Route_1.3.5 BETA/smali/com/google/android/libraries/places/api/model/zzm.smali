...
.method public final getHoursType()Lcom/google/android/libraries/places/api/model/OpeningHours$HoursType;
    ...
    iget-object v0, p0, Lcom/google/android/libraries/places/api/model/zzm;->zza:Lcom/google/android/libraries/places/api/model/OpeningHours$HoursType;
...
.method public final getSpecialDays()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzc:Ljava/util/List;
...
.method public final getWeekdayText()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzd:Ljava/util/List;
...
.method public final setHoursType(Lcom/google/android/libraries/places/api/model/OpeningHours$HoursType;)Lcom/google/android/libraries/places/api/model/OpeningHours$Builder;
    ...
    iput-object p1, p0, Lcom/google/android/libraries/places/api/model/zzm;->zza:Lcom/google/android/libraries/places/api/model/OpeningHours$HoursType;
...
.method public final setSpecialDays(Ljava/util/List;)Lcom/google/android/libraries/places/api/model/OpeningHours$Builder;
    ...
    iput-object p1, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzc:Ljava/util/List;
...
.method public final setWeekdayText(Ljava/util/List;)Lcom/google/android/libraries/places/api/model/OpeningHours$Builder;
    ...
    iput-object p1, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzd:Ljava/util/List;
...
.method public final zza()Lcom/google/android/libraries/places/api/model/OpeningHours;
    ...
    iget-object v1, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzc:Ljava/util/List;

    if-eqz v1, :cond_1

    iget-object v2, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzd:Ljava/util/List;
    ...
    :cond_0
    new-instance v3, Lcom/google/android/libraries/places/api/model/zzas;

    iget-object v4, p0, Lcom/google/android/libraries/places/api/model/zzm;->zza:Lcom/google/android/libraries/places/api/model/OpeningHours$HoursType;

    invoke-direct {v3, v4, v0, v1, v2}, Lcom/google/android/libraries/places/api/model/zzas;-><init>(Lcom/google/android/libraries/places/api/model/OpeningHours$HoursType;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object v1, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzb:Ljava/util/List;
    ...
    :cond_3
    iget-object v1, p0, Lcom/google/android/libraries/places/api/model/zzm;->zzd:Ljava/util/List;
